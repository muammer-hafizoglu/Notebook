        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalFileSize = table.Column<string>(nullable: true),
                    SingleFileSize = table.Column<string>(nullable: true),
                    CanUploadFile = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Explation = table.Column<string>(nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "ID", "Approve", "Avatar", "CanUploadFile", "CreateDate", "Email", "Info", "LastActiveDate", "Lock", "Name", "Password", "RoleID", "SingleFileSize", "TotalFileSize", "Username" },
                values: new object[] { "23m454h5", true, "/notebook/images/avatar.png", false, new DateTime(2019, 9, 29, 5, 56, 20, 918, DateTimeKind.Local).AddTicks(5343), "mhaf69@gmail.com", null, new DateTime(2019, 9, 29, 5, 56, 20, 919, DateTimeKind.Local).AddTicks(3257), false, "Muammer Hafızoğlu", "D3CE20FCCBE7D116ECD0", null, null, null, "muammer.hafizoglu" });
